      ...
      <template v-slot="{ inputValue, inputEvents }">
        <div class="row">
          <div class="col-md-6" style="text-align-last: left">
            ...
            <input
              readonly="readonly"
              class="radius-style date_picker_date"
          ...
          <div class="col-md-6" style="text-align-last: left">
            <div class="date_picker_title" style="padding-left: 75px">Check-Out</div>
            <input
              readonly="readonly"
              class="radius-style date_picker_date"
              style="height: auto !important; background: transparent; padding-left: 75px"
              :value="getDateEnd()"
            />
          </div>
        </div>
...
export default {
  ...
  methods: {
    onDayClick(day) {
      this.$store.commit("setStartDate", format(this.range.start, this.dateFormat));
