...
export default {
  ...
  async created() {
    var bookingId = this.$router.history.current.params["id"];
    var reservationCode = this.$router.history.current.params["reservationCode"];
    var body = {
      bookingId: bookingId,
      reservasionId: reservationCode,
    };
    ...
    this.$store.commit("setBoatDetailId", data.boatid);
